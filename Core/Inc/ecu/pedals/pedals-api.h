 ...
 *
 * \param[in] get_tick A callback function to retrieve the current system tick in milliseconds.
 *
...
/*!
 * \brief Checks if the pedals module has timed out based on the last update tick.
 *
 * \return \c true if the time since the last update exceeds the timeout threshold, \c false otherwise.
 */
