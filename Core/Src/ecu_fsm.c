...
const char *state_names[] = {"init", "post", "fatal_error", "enable_inv_updates", "flash", "idle", "pause", "check_inv_settings", "start_ts_precharge", "wait_ts_precharge", "start_ts_discharge", "wait_driver", "disable_inv_drive", "wait_ts_discharge", "enable_as_driver", "enable_inv_drive", "as_init_error", "disable_as_driver", "r2d", "re_enable_inv_drive"};
