...
void HAL_ADC_MspInit(ADC_HandleTypeDef *adcHandle) {
    ...
    PA5     ------> ADC1_IN5
    */
        GPIO_InitStruct.Pin = SD_OUT_READ_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        HAL_GPIO_Init(SD_OUT_READ_GPIO_Port, &GPIO_InitStruct);

        GPIO_InitStruct.Pin = SD_IN_READ_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        HAL_GPIO_Init(SD_IN_READ_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *adcHandle) {
    ...
    PA5     ------> ADC1_IN5
    */
        HAL_GPIO_DeInit(SD_OUT_READ_GPIO_Port, SD_OUT_READ_Pin);

        HAL_GPIO_DeInit(SD_IN_READ_GPIO_Port, SD_IN_READ_Pin);
