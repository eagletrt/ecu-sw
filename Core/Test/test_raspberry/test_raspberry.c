...
void setUp(void) {
    ...
    raspberry_api_init(pin_control, RASPBERRY_CONTROL_PIN_STATE_ON);
...
void test_rasp_api_init_null_pin_control(void) {
    enum RaspberryReturnCode rc = raspberry_api_init(NULL, RASPBERRY_CONTROL_PIN_STATE_ON);
...
void test_rasp_api_init_invalid_control_pin_state(void) {
    enum RaspberryReturnCode rc = raspberry_api_init(pin_control, 99U);
...
void test_rasp_api_init_pin_control_callback_error(void) {
    ...
    enum RaspberryReturnCode rc = raspberry_api_init(pin_control, RASPBERRY_CONTROL_PIN_STATE_OFF);
...
void test_rasp_api_init_pin_control_on(void) {
    enum RaspberryReturnCode rc = raspberry_api_init(pin_control, RASPBERRY_CONTROL_PIN_STATE_ON);
...
void test_rasp_api_change_pin_state_invalid_control_pin_state(void) {
    enum RaspberryReturnCode rc = raspberry_api_change_pin_state(99U);
...
void test_rasp_api_change_pin_state_unchanged_state(void) {
    ...
    raspberry_api_change_pin_state(99U);
...
void test_rasp_api_change_pin_state_pin_controll_callback_error(void) {
    pin_control_fake.return_val = RASPBERRY_RC_ERROR;
    enum RaspberryReturnCode rc = raspberry_api_change_pin_state(RASPBERRY_CONTROL_PIN_STATE_ON);
...
void test_rasp_api_change_pin_state_success(void) {
    ...
    raspberry_api_init(pin_control, current_state);
    enum RaspberryReturnCode rc = raspberry_api_change_pin_state(expected_state);
