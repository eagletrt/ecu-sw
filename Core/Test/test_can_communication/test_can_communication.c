...
EAGLETRT_STATIC struct CanCommunicationNetworkConfig test_valid_configs[CAN_COMMUNICATION_NETWORK_COUNT];
...
void test_can_communication_api_init_should_fail_on_missing_mandatory_send_callback(void) {
    ...
    struct CanCommunicationNetworkConfig invalid_configs[CAN_COMMUNICATION_NETWORK_COUNT] = {
        [CAN_COMMUNICATION_NETWORK_PRIMARY] = { .send = NULL, .on_receive = mock_application_on_receive },
        [CAN_COMMUNICATION_NETWORK_SECONDARY] = { .send = mock_can_send, .on_receive = mock_application_on_receive },
        [CAN_COMMUNICATION_NETWORK_INVERTER] = { .send = mock_can_send, .on_receive = mock_application_on_receive }
    };
...
void test_can_communication_api_init_should_fail_on_missing_mandatory_receive_callback(void) {
    ...
    struct CanCommunicationNetworkConfig invalid_configs[CAN_COMMUNICATION_NETWORK_COUNT] = {
        [CAN_COMMUNICATION_NETWORK_PRIMARY] = { .send = mock_can_send, .on_receive = mock_application_on_receive },
        [CAN_COMMUNICATION_NETWORK_SECONDARY] = { .send = mock_can_send, .on_receive = NULL },
        [CAN_COMMUNICATION_NETWORK_INVERTER] = { .send = mock_can_send, .on_receive = mock_application_on_receive }
    };
...
void test_can_communication_api_add_to_rx_should_fail_on_null_frame(void) {
    enum CanCommunicationReturnCode rc = can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, NULL);
...
void test_can_communication_api_add_to_rx_should_fail_on_invalid_length(void) {
    ...
    enum CanCommunicationReturnCode rc = can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, &frame);
...
void test_can_communication_api_add_to_rx_should_fail_on_invalid_network_bounds(void) {
    ...
    enum CanCommunicationReturnCode rc = can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_COUNT, &frame);
...
void test_can_communication_api_add_to_rx_should_fail_with_queue_full(void) {
    ...
    for (uint32_t i = 0; i < CAN_COMMUNICATION_RX_QUEUE_CAPACITY; i++) {
        nominal_rcs[i] = can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, &frame);
    }

    saturation_rc = can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, &frame);
...
void test_can_communication_api_process_rx_should_fail_on_invalid_network_bounds(void) {
    enum CanCommunicationReturnCode rc = can_communication_api_process_rx(CAN_COMMUNICATION_NETWORK_COUNT);
...
void test_can_communication_api_process_rx_should_drain_entire_queue_to_dispatcher(void) {
    ...
    can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, &raw_frame_one);
    can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, &raw_frame_two);

    process_rc = can_communication_api_process_rx(CAN_COMMUNICATION_NETWORK_PRIMARY);
...
void test_can_communication_api_process_rx_should_forward_receive_handler_errors(void) {
    ...
    can_communication_api_add_to_rx(CAN_COMMUNICATION_NETWORK_PRIMARY, &raw_frame);
...
void test_can_communication_api_add_to_tx_should_fail_on_null_frame(void) {
    enum CanCommunicationReturnCode rc = can_communication_api_add_to_tx(CAN_COMMUNICATION_NETWORK_INVERTER, NULL);
...
void test_can_communication_api_add_to_tx_should_fail_on_invalid_length(void) {
    ...
    enum CanCommunicationReturnCode rc = can_communication_api_add_to_tx(CAN_COMMUNICATION_NETWORK_INVERTER, &frame);
...
void test_can_communication_api_add_to_tx_should_fail_on_invalid_network_bounds(void) {
    ...
    enum CanCommunicationReturnCode rc = can_communication_api_add_to_tx(CAN_COMMUNICATION_NETWORK_COUNT, &frame);
...
void test_can_communication_api_add_to_tx_should_fail_with_queue_full(void) {
    ...
    for (uint32_t i = 0; i < CAN_COMMUNICATION_TX_QUEUE_CAPACITY; i++) {
        nominal_rcs[i] = can_communication_api_add_to_tx(CAN_COMMUNICATION_NETWORK_INVERTER, &frame);
    }

    saturation_rc = can_communication_api_add_to_tx(CAN_COMMUNICATION_NETWORK_INVERTER, &frame);
...
void test_can_communication_api_process_tx_should_fail_on_invalid_network_bounds(void) {
    enum CanCommunicationReturnCode rc = can_communication_api_process_tx(CAN_COMMUNICATION_NETWORK_COUNT);
...
void test_can_communication_api_process_tx_should_flush_to_hardware(void) {
    ...
    can_communication_api_add_to_tx(CAN_COMMUNICATION_NETWORK_INVERTER, &frame);

    process_rc = can_communication_api_process_tx(CAN_COMMUNICATION_NETWORK_INVERTER);
