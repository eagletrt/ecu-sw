...
void test_handle_frame_decodes_wheel_outbound_a(void) {
    ...
    union CanInvertersMessages msg = {
        .inverter1outbounda.inverterstate = EPHORUS_STATE_DRIVE,
        .inverter1outbounda.inverterready = 1,
        .inverter1outbounda.torqueactual = 4.5f,
        .inverter1outbounda.temperaturemotor = 42.0f,
        .inverter1outbounda.temperaturepowerswitches = 55.0f,
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER1OUTBOUNDA, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER1OUTBOUNDA, data);
...
void test_handle_frame_decodes_wheel_outbound_b(void) {
    ...
    union CanInvertersMessages msg = {
        .inverter1outboundb.speedactual = -2500,
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER2OUTBOUNDB, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER2OUTBOUNDB, data);
...
void test_handle_frame_routes_only_to_addressed_wheel(void) {
    ...
    union CanInvertersMessages msg = {
        .inverter1outboundb.speedactual = 999,
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER2OUTBOUNDB, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER2OUTBOUNDB, data);
...
void test_handle_frame_decodes_general_telemetry(void) {
    ...
    union CanInvertersMessages msg = {
        .generaloutbound.dclinkvoltage12actual = 560.0f,
        .generaloutbound.dclinkvoltage34actual = 548.0f,
        .generaloutbound.dclinkgood12 = 1,
        .generaloutbound.dclinkgood34 = 0,
        .generaloutbound.mirrorcontrolenable = 1,
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALOUTBOUND, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALOUTBOUND, data);
...
void test_handle_frame_ignores_inactive_wheel(void) {
    ...
    union CanInvertersMessages msg = {
        .inverter1outboundb.speedactual = 4321,
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER2OUTBOUNDB, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_INVERTER2OUTBOUNDB, data);
...
void test_faults_per_inverter_latch_only_that_wheel(void) {
    ...
    union CanInvertersMessages msg = {
        .generalerrorbits.err_inverter2_overcurrent = 1, // inverter 2 == front-right
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALERRORBITS, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALERRORBITS, data);
...
void test_faults_global_hit_every_active_wheel(void) {
    ...
    union CanInvertersMessages msg = {
        .generalerrorbits.err_controldisabled = 1, // system-wide
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALERRORBITS, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALERRORBITS, data);
...
void test_faults_dc_bus_hit_only_that_pair(void) {
    ...
    union CanInvertersMessages msg = {
        .generalerrorbits.err_inverter1_2_dc_undervoltage = 1,
    };
    uint8_t data[EPHORUS_FRAME_DATA_SIZE] = { 0 };
    EAGLETRT_API_UNUSED(can_inverters_api_serialize_from_id(CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALERRORBITS, &msg, data));
    ephorus_api_handle_frame(&handle, CAN_INVERTERS_MESSAGE_FRAME_ID_GENERALERRORBITS, data);
